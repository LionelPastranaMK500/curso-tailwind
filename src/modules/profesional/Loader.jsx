...
const Loader = () => {
  return (
    // 1. ELIMINAMOS los divs 'main-container' y 'loader'
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  /* 2. APLICA LOS ESTILOS DE TAMAÑO AQUÍ */
  width: 100%;
  max-width: 800px; /* Le damos un max-width basado en el viewBox */
  padding: 1rem; /* Añadimos algo de espacio */

  /* El .main-container ya no existe, por lo que su CSS se borra */

  /* El .loader ya no existe, por lo que su CSS se borra */
  ...
  /* ... (El resto de tus estilos .trace-flow, .yellow, @keyframes, etc. van aquí) ... */
  .trace-flow {
    stroke-width: 1.8;
    fill: none;
